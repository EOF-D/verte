...
\begin{table}[H]
	...
	\begin{tabular}{@{}lll@{}}
		...
		\file{codegen/register\_allocator.[hpp/cpp]}       & Register management      & Physical register allocation      \\
		\file{codegen/asm\_emitter.[hpp/cpp]}              & Code emission            & NASM assembly text generation     \\
